...
const i18n = {
    en: {
        ...
        'chat.packages.text': 'All 29 travel packages are displayed in the **Destinations & Packages** section on the site. Each package includes a photo gallery with 4 images, detailed description, price and duration of stay. You can filter by category (Beach, City Break, Exotic, etc.) and by budget.\n\nWould you like to see the packages now?',
    ...
    it: {
        ...
        'chat.packages.text': 'Tutti i 29 pacchetti turistici sono visualizzati nella sezione **Destinazioni & Pacchetti** del sito. Ogni pacchetto include una galleria fotografica con 4 immagini, descrizione dettagliata, prezzo e durata del soggiorno. Puoi filtrare per categoria (Spiaggia, City Break, Esotico, ecc.) e per budget.\n\nVuoi vedere i pacchetti ora?',
